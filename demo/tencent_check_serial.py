...
if __name__ == '__main__':
    ...
    select_sql = 'SELECT id,dname,parse_count FROM %s WHERE safe_tencent IS NULL LIMIT 1000' % table_name
    while True:
        ...
        if select_result:
            ...
            data_list = [tmp.values() for tmp in checked_results]
            mydict = checked_results[0]
            ...
            try:
                ...
                result = cursor.executemany(insert_sql, data_list)
                conn.commit()
